...
if __name__ == '__main__':
    ...
    numberOfPureExploreMoves=20000 #numberOfEpsilonGreedy would be "numberOfMoves-numberOfPureExploreMoves".
#     numberOfPureExploitMoves=20000
    numberOfTestEvents=20
#     numberOfRoundsExperiments=10
    n=int(numberOfMoves/numberOfSteps)  #Make sure it gives and integer
    timeStepUpperBound=30000
    stepSize=1
